...
const AccountPlans = () => {
  ...
  const fetchPlans = async () => {
    try {
      const res = await fetch("https://api.fundednaira.net/api/admin/get-plans.php");
  ...
  const addPlan = async () => {
    ...
    try {
      const res = await fetch("https://api.fundednaira.net/api/admin/add-plan.php", {
        method: "POST",
        headers: {
  ...
  const updatePlan = async () => {
    ...
    try {
      const res = await fetch("https://api.fundednaira.net/api/admin/update-plan.php", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const deletePlan = async (id) => {
    try {
      const res = await fetch("https://api.fundednaira.net/api/admin/delete-plan.php", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
