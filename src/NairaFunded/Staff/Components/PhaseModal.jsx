    ...
    const fetchDetails = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `https://api.fundednaira.net/api/Staff/get-phase-request-account-details.php?account_id=${data.account_id}`,
          {
            method: "GET",
            headers: {
        ...
        */
        ...
        if (result.success) {
          ...
          console.error(
            result.message || "Failed to load account details"
          );
        }
      } catch (error) {
  ...
  const handleAction = async (action) => {
    try {
      ...
      */
      ...
      const res = await fetch(
        "https://api.fundednaira.net/api/Staff/update-phase-request.php",
        {
          method: "POST",
          headers: {
  ...
  */
  ...
  const submitFailedReason = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "https://api.fundednaira.net/api/Staff/update-account-status.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      */
      ...
      console.error("submitFailedReason error:", error);
